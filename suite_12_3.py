...
circle = unittest.TestSuite()
circle.addTest(unittest.TestLoader().loadTestsFromTestCase(RunnerTest))
circle.addTest(unittest.TestLoader().loadTestsFromTestCase(TournamentTest))
